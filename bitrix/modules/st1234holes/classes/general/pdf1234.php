...
class pdf1234{
	...
	protected function text_snow(){
		$ar['body0'] = '    '.$this->params['date1.day'].'.'.$this->params['date1.month'].'.'.$this->params['date1.year'].' мною на территории дороги по адресу: '.$this->params['street'];
		$ar['body1'] = 'был обнаружен участок с неубранным снегом. Считаю, что неубранный снег на данном участке представляет опасность для участников дорожного движения, и в соответствии с пунктом 3.1.6 ГОСТ Р 50597-93 «Автомобильные дороги и улицы. Требования к эксплуатационному состоянию, допустимому по условиям обеспечения безопасности дорожного движения», должен быть устранён не позднее шести часов после обнаружения или окончания снегопада. Статьей 1 ФЗ «О безопасности дорожного движения» в качестве задачи определена охрана жизни, здоровья и имущества граждан, защита их прав и законных интересов, общества и государства путем предупреждения дорожно-транспортных происшествий, снижения тяжести их последствий. Основные требования по обеспечению безопасности дорожного движения при содержании дорог определяются ст. 12 указанного закона, в соответствии с которой содержание дорог на территории РФ должно обеспечивать безопасность дорожного движения.';
		$ar['footerUP0'] = '   В соответствии с п.19 ч.1 ст.12 ФЗ «О полиции» на полицию возлагается обязанность по осуществлению государственного контроля (надзора) за соблюдением правил, стандартов, технических норм и иных требований нормативных документов в области обеспечения безопасности дорожного движения. В связи с изложенным, на основании п.11 Положения «О ГИБДД МВД РФ», ст. 12 ФЗ «О полиции», п.3 ч.1.ст. 28.1, ч.1 ст29.13 КоАП Российской Федерации прошу:';
		$ar['count'][1] = 'Возбудить дело об административном правонарушении по ст.12.34 КоАП РФ «Несоблюдение требований по обеспечению безопасности дорожного движения при ремонте и содержании дорог, железнодорожных переездов или других дорожных сооружений»';
		$ar['count'][2] = 'Выдать предписание о принятии мер по устранению указанных недостатков.';
		$ar['count'][3] = 'По существу моего заявления и о принятых мерах сообщить мне письменно.';
		return $ar;
	}
