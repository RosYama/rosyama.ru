<?php
$MESS['FRESH_HOLES']           = 'Новые дефекты';
$MESS['INPROGRESS_HOLES']      = 'В ожидании';
$MESS['FIXED_HOLES']           = 'Отремонтированные';
$MESS['HOLE_STATE_fresh']      = 'Добавлено на сайт';
$MESS['HOLE_STATE_inprogress'] = 'В ГИБДД';
$MESS['HOLE_STATE_fixed']      = 'Отремонтировано';
$MESS['HOLE_STATE_achtung']    = 'В ГИБДД';
$MESS['HOLE_STATE_gibddre']    = 'Получен ответ';
$MESS['HOLE_STATE_prosecutor'] = 'Жалоба в прокуратуре';
