...
/// Подключение основных модулей и классов
...
/// Создание объекта popup для карты
...
//// Получение массива данных по карте из запроса
...
///// Подключение основного компонента вывода карты в 1С-Битрикс
